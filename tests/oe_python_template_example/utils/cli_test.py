...
from oe_python_template_example.utils._cli import prepare_cli

# Constants to avoid duplication
LOCATE_IMPLEMENTATIONS_PATH = "oe_python_template_example.utils._cli.locate_implementations"
...
def test_prepare_cli_conditional_epilog_recursion(
    ...
    with (
        ...
        patch("oe_python_template_example.utils._cli.Path") as mock_path,
        patch("oe_python_template_example.utils._cli._add_epilog_recursively") as mock_add_epilog,
    ):
