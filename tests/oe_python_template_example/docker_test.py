"""Tests to verify the CLI functionality of OE Python Template Example works with Docker."""
...
def test_core_docker_cli_help_with_love(docker_services) -> None:
    ...
    out = docker_services._docker_compose.execute("run oe-python-template-example --help")
